...
local ImportBytecode = script:WaitForChild("ImportBytecode")
local ForceLoad = script:WaitForChild("ForceLoad")
function proxyFENV(a,b,c)
...
for Object,BC = ImportBytecode:InvokeServer() do
    Loads[Object] = lua_wrap_state(bc_to_state(BC),proxyFENV(getfenv(),{
        script = Object,
        require = require
    }))
end
